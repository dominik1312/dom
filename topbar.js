...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://gcqaaunceyzjciwbwphj.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable_d1PEu6Pu4_ruTXgF7kU6mA_kR5SKEO4';
...
<nav class="bottombar" id="bottombar" role="navigation" aria-label="Main tabs">
  ...
  <a href="schedule.html" class="bottombar-tab" data-page="planner">
    <span class="bottombar-tab-icon">📅</span><span>Day Planner</span>
  </a>
</nav>`;
  ...
  function currentPageKey() {
    ...
    if (p.endsWith('schedule.html')) return 'planner';
    return 'main';
  }
